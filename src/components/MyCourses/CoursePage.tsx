          ...
          {({ open }) => (
            <>
              ...
              <Disclosure.Panel className="px-4 pt-4 pb-2 text-sm text-gray-500">
                <p className="mb-2"><span className="font-medium">Сложность:</span> {course.difficulty}</p>
                <p className="mb-2"><span className="font-medium">Время на завершение:</span> {course.time_to_complete_hours} минут</p>
                <p className="mb-2"><span className="font-medium">Для кого:</span> {course.for_who}</p>
                <p className="mb-2"><span className="font-medium">Описание:</span> {course.about}</p>
              </Disclosure.Panel>
            </>
          )}
        </Disclosure>
